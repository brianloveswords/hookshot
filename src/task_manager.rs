...
//!
//! - There should be a way to block the main thread so it doesn't end
//! while there are still active workers.
//!
//! # Examples
//!
...
//! use std::thread;
//!
//! # fn do_some_hard_work(){ thread::sleep_ms(100); }
